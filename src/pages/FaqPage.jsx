...
const faqs = [
  {
    q: 'Is it VeriRec mematuhi Akta Perlindungan Data Peribadi (PDPA) 2010?',
    a: 'Ya. VeriRec direka khusus untuk pematuhan PDPA Malaysia. Setiap sesi memerlukan borang persetujuan maklum (informed consent) yang ditandatangani secara digital, dengan cap masa, versi, dan audit trail yang tidak boleh deleted. Data persetujuan disimpan secara kekal sebagai rekod pematuhan.',
  },
  {
  ...
  {
    q: 'What is itu hash SHA-256 dan bagaimana ia berfungsi?',
  ...
  {
    q: 'Can I saya memadam rakaman dan data sesi?',
  ...
  {
    q: 'What is format audio yang disokong?',
  ...
  {
    q: 'Is it VeriRec berfungsi tanpa sambungan internet?',
  ...
  {
    q: 'How many lama untuk berhenti langgan?',
  ...
  {
    q: 'Is it VeriRec sesuai untuk digunakan dalam mahkamah?',
...
export default function FaqPage() {
  ...
  return (
    <>
    <Helmet>
      <title>Frequently Asked Questions — VeriRec</title>
      <meta name="description" content="Answers kepada soalan lazim tentang VeriRec — pematuhan PDPA, keselamatan data, transkrip, rakaman audio, dan pelan harga." />
      <link rel="canonical" href="https://www.verirec.app/faq" />
      <meta property="og:type" content="website" />
      <meta property="og:url" content="https://www.verirec.app/faq" />
      <meta property="og:title" content="Frequently Asked Questions — VeriRec" />
      <meta property="og:description" content="Answers kepada soalan lazim tentang VeriRec — pematuhan PDPA, keselamatan data, transkrip, dan pelan harga." />
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 mt-3">Answers kepada soalan yang paling kerap ditanya tentang VeriRec</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border p-8">
          ...
          {sent ? (
            <div className="text-center py-8">
              ...
              <p className="font-medium text-gray-900">Mesej anda telah sent.</p>
