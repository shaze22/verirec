  ...
  return (
    <div className="flex gap-2 p-3 border-t bg-white">
      <input
        ...
        placeholder="Tambah nota atau bendera semasa sesi..."
        className="flex-1 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
        aria-label="Tambah nota atau bendera"
      />
      <button
        onClick={() => submit('note')}
        disabled={!text.trim()}
        ...
        title="Tambah nota (Enter)"
        aria-label="Tambah nota"
      >
      ...
      <button
        ...
        aria-label="Tandakan sebagai bendera merah"
      >
        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9" />
        </svg>
        <span className="hidden sm:inline">Bendera</span>
      </button>
    </div>
  );
}
